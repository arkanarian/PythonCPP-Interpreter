...
//  int main = 6; // само слово main не зарезервировано и может использоваться если main была функцией а это переменная
//  char a = 'a', r = '3';
//  char b = 'a';
...
//  char c = a + b; // непонятный момент
  cout << a << endl;
  cout << 3+2*5 << 2 << endl; // ФИЧА: не отлавливается как битовый сдвиг
  int dtg = 3 << 2; // ФИЧА: отлавливается как битовый сдвиг
  cout << include << endl;
  cout << b << endl;
  cout << include << endl;
  cout << bc << endl;
